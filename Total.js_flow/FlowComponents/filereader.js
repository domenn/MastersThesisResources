...
exports.install = function(instance) {
    ...
    instance.on('data', function(flowdata) {
        ...
        if (type === 'buffer')
            ...
            Fs.readFile(path, enc, function(err, fileData){
                if (err) {
                    instance.error(err);
                    return;
                }
                    ...
                    flowdata.data.data = fileData;
                    instance.send(0, flowdata);
                //    s= C:\\Users\\domen\\Everything\\magisterska\\random_files\\HugeHtmlAsArrayCopyPastableSHORT.txt\
